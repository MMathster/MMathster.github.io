...
where $\Re(\alpha) > 0$, $\beta$ is a non-negative integer, and $Q(x)$ is an admissible factor. See <a href="/assets/logfrac20260318.pdf" download class="download-btn">
